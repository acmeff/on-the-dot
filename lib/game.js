...
class Game {
  ...
  setUp(){
    ...
    this.card1 = new Card(
      this.ctx1, this.canvas1, 1, [[285*.85, 75*.85], [75*.85, 195*.85], [105*.85, 75*.85], [225*.85, 285*.85]]);
    ...
    this.card2 = new Card(
      this.ctx2, this.canvas2, 2, [[15*.85, 225*.85], [225*.85, 105*.85], [105*.85, 75*.85], [225*.85, 285*.85]]);
    ...
    this.card3 = new Card(
      this.ctx3, this.canvas3, 3, [[75*.85, 195*.85], [285*.85,75*.85], [225*.85, 285*.85], [105*.85, 75*.85]]
    );
    ...
    this.card4 = new Card(
      this.ctx4, this.canvas4, 4, [[225*.85, 105*.85], [15*.85, 225*.85], [225*.85, 285*.85], [105*.85, 75*.85]]
    );
