...
var Card = function () {
  ...
  _createClass(Card, [{
    ...
    value: function randomPosition() {
      ...
      for (var _i = 0; _i < Math.floor(Math.random() * 4); _i++) {
      ...
      for (var _i2 = 0; _i2 < Math.floor(Math.random() * 2); _i2++) {
...
var Demo = function () {
  ...
  _createClass(Demo, [{
    ...
    value: function text() {
      ...
      setTimeout(function () {
        return _this.highlight('target-canvas');
      }, 1000);
      setTimeout(function () {
        return _this.flashText('two');
      }, 3000);
      setTimeout(function () {
        return _this.highlight('stack');
      }, 3000);
      setTimeout(function () {
        return _this.flashText('three');
      }, 5000);
      setTimeout(function () {
        return _this.highlight('canvas-1');
      }, 5000);
      setTimeout(function () {
        return _this.highlight('canvas-2');
      }, 5000);
      setTimeout(function () {
        return _this.highlight('canvas-3');
      }, 5000);
      setTimeout(function () {
        return _this.highlight('canvas-4');
      }, 5000);
      setTimeout(function () {
        return _this.cards();
      }, 7000);
